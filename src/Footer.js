...
function Brandlogo() {
  let logo = ["1", "2", "3", "4", "5", "6"];

  return (
    <div className="brandlogo-wrap">
      <Container>
        <Row>
          {logo.map((number, index) => (
            <Col xs={4} md={4} lg={2}>
              <div className="brandlogo">
                <a href="#">
                  <img src={process.env.PUBLIC_URL + "/img/brandlogo" + [number] + ".webp"} />
                </a>
              </div>
            </Col>
          ))}
    ...
    <>
        ...
        <Container>
          <div className="footer-list-wrap">
            <ul className="footer-list">
              <li className="footer-li-big">
                <div>
                  <a>
                    <img src={process.env.PUBLIC_URL + "/img/logo.webp"} />
                  </a>
                  <p className="footer-txt">Tortor neque egestas augue, eu vulputate magnaTortor neque</p>
                  <div className="pay">
                    <a href="#">
              ...
              <li className="footer-li-big">
                ...
                <div className="footer-search">
                  <input type="searchbox" name="contact[email]" placeholder="Enter Your Email Address" />
                  <button type="submit">
      ...
      <footer className="footer-bottom">
        <Container>
          <Row>
            <Col>
              <ul className="footer-bottom-wrap">
                <li>
                  <p>
                    <span>Copyright</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
                    ...
                    <span>2022 Pmart rights reserved</span>
                  </p>
                </li>
              </ul>
            </Col>
